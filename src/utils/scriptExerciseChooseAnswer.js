document.addEventListener("astro:page-load", () => {
  let currentExercise = 0; // Índice del ejercicio actual
  const totalExercises = 8; // Total de ejercicios
  let mistakes = Array(totalExercises).fill(0); // Array para contar errores por ejercicio

  // Función para validar la respuesta del usuario
  function validateAnswer(exerciseIndex, answer, button) {
    ...
    if (answer === "correct") {
      ...
      if (currentExercise < totalExercises - 1) {
        document.getElementById("continueButton").style.display = "block"; // Muestra el botón de "Continuar"
      } else {
      ...
      document.getElementById("retryButton").style.display = "block"; // Muestra el botón de "Intentar de nuevo"
    }
  }
  ...
  function continueExercise() {
    ...
    document.getElementById("continueButton").style.display = "none"; // Oculta el botón de "Continuar"
  ...
  function retry() {
    ...
    document.getElementById("feedback").innerHTML = "";
    document.getElementById("retryButton").style.display = "none"; // Oculta el botón de "Intentar de nuevo"
